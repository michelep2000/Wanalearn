...
import 'package:wanalearn/core/utils/constants.dart';
...
class AuthenticationRemoteDataSourceImpl
  ...
  Future<void> signUp({
    ...
    try {
      ...
      await result.user?.updatePhotoURL(kDefaultAvatar);
  ...
  Future<void> _setUserData(User user, String fallbackEmail) async {
    await _cloudStorageClient.collection('users').doc(user.uid).set(
          LocalUserModel(
            uid: user.uid,
